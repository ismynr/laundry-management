...
@section('modals')
  @include('karyawan.expanse_management.modals.add-modal')
  @include('karyawan.expanse_management.modals.edit-modal')
@endsection
...
@push('script')
    ...
    @include('karyawan.expanse_management.owner.JS')
@endpush