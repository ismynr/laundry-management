<script>
    $(function () {
        ...
        let table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('karyawan.expanses.indexOwner') }}",
            columns: [
                ...
                {data: 'action', name: 'action', orderable: false, searchable: false,
                    render: function( data, _type, _full ) {
                        let btn = null;
                        btn = '<button type="button" data-id="/api/karyawan/expanses/' + data + '" class="editBtn btn btn-gradient-info btn-sm mr-1 mb-1"><i class="mdi mdi-pencil menu-icon"></i> Edit</button>';
                        btn += '<button data-id="/api/karyawan/expanses/' + data + '" class="deleteBtn btn btn-gradient-danger btn-sm"><i class="mdi mdi-delete menu-icon"></i> Delete</button>';
                        return btn;
                }},
            ]
        });
