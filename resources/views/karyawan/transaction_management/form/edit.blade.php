...
@section('title', 'Edit Transaction Karyawan')
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          @endif
            ...
            <a href="{{ route('karyawan.transactions.invoice', $transaction->id) }}" target="_blank" class="btn btn-light float-right mr-2">
              <i class="mdi mdi-printer"></i> Cetak Kuitansi
            </a>
            <a href="#" onclick="claimTransaction('{{ route('karyawan.transactions.claimTransaction', $transaction->id) }}')" 
...
@section('modals')
  ...
  @include('karyawan.transaction_management.modals.print-mark-modal')
@endsection
...
@push('script')
    ...
    @include('karyawan.transaction_management.form.JS.edit-JS')
@endpush