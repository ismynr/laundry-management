<script>
    $(function() {
        ...
        let table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('karyawan.customers.index') }}",
            columns: [
                ...
                render: function( data, _type, _full ) {
                            let btn;
                            btn = '<button type="button" data-id="/api/karyawan/customers/' + data + '" class="editBtn btn btn-gradient-info btn-sm mr-1"><i class="mdi mdi-pencil menu-icon"></i> Edit</button>';
                            btn += '<button data-id="/api/karyawan/customers/' + data + '" class="deleteBtn btn btn-gradient-danger btn-sm"><i class="mdi mdi-delete menu-icon"></i> Delete</button>';
                            return btn;
                }},
            ]
        });
